...
export const setBooks = (booksList, searchText, orderBy, category) => ({
  type: SET_BOOKS,
  booksList,
  searchText,
  orderBy,
...
export const setMoreBooks = (booksList) => ({
  type: SET_MORE_BOOKS,
  booksList,
});
...
export const setTextError = (hasErorr) => ({ type: SET_TEXT_ERROR, hasErorr });

export const setMoreLoading = (isMoreLoading) => ({
  type: SET_MORE_LOADING,
  isMoreLoading,
});

export const setBooksCount = (booksCount) => ({
...
export const getMoreBooks =
  (searchText, orderBy, category, startIndex) => async (dispatch) => {
...
export const getBooksList =
  (searchText, orderBy, category) => async (dispatch) => {
    if (!searchText) {
